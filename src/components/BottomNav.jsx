          ...
          return (
            <button
              ...
              style={{
                ...
                position: 'relative',
                marginTop: tab.isCenter ? '-10px' : '0',
              }}
            >
              {tab.isCenter ? (
                <>
                  <div
                    className={isActive ? 'animate-neon-pulse' : ''}
                    style={{
                      width: '50px',
                      height: '50px',
                      borderRadius: '50%',
                  ...
                  <span className="font-korean" style={{ fontSize: '10px', marginTop: '2px' }}>
                    {tab.label}
                  </span>
                </>
              ) : (
                <>
                  ...
                  <span className="font-korean" style={{ fontSize: '10px' }}>
                    {tab.label}
                  </span>
                  {isActive && (
                    <div
